...
def generate_relu_onnx_and_data(save_path=None):
    """ Generate ONNX model for ReLU operator based on config, with optional save path """
    ...
    # Generate random input data (with some negative values) and save it directly
    ...
    model_def = helper.make_model(graph_def, producer_name="relu_model", opset_imports=[helper.make_opsetid("", 13)])
...
if __name__ == "__main__":
    ...
    generate_relu_onnx_and_data(save_path)